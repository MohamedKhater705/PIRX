...
function StepIndicator({
  ...
  return (
    <motion.div
      ...
      <motion.div
        variants={{
          inactive: { scale: 2, backgroundColor: "#222", color: "#a3a3a3" },
          active: { scale: 2, backgroundColor: "#5227FF", color: "#5227FF" },
          complete: { scale: 2, backgroundColor: "#5227FF", color: "#3b82f6" },
        }}
